def paragraph_extractor(url):
    ...
    try:
        ...
        all_ps = soup.find_all("p") + soup.find_all("em") + soup.find_all("li") + soup.find_all("address") + soup.find_all("h1") + soup.find_all("h2") + soup.find_all("h3") + soup.find_all("h4") + soup.find_all("h5") + soup.find_all("h6") + soup.find_all("a") + soup.find_all("strong")
        ...
        paragraf += (meta_property + meta_name + email + div_address).lower()
